...
%   I: INPUT IMAGE
%   nSc: number of scale
%   feature: Returned feature on Block_DCT statiss
...
% ori_rho_L1 = blkproc(im,[3,3],[2,2],@oriented_dct_rho_config3);

values = blkproc(im,[3,3],[2,2],@dct_window);

gama_L1 = values(:,1:3:end);
coeff_var_L1 = values(:,2:3:end);
ori_rho_L1 = values(:,3:3:end);
...
feature=[p10_gama_L1 p100_gama_L1 p10_last_gama_L1];
...
feature=[feature p10_cv_L1 p100_cv_L1 p10_last_cv_L1];
...
feature=[feature p10_orientation_L1 p100_orientation_L1 p10_last_orientation_L1];
